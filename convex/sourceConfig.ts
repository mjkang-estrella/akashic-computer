...
export const CURRENT_MONITORED_SOURCES: SeedSource[] = [
  ...
  { owner: "nvidia", displayName: "NVIDIA", role: "creator_provider", familyIds: ["nemotron", "cosmos3", "parakeet", "lyra", "gr00t", "sana-wm"], includePatterns: ["nvidia/*Nemotron*", "nvidia/*Cosmos*", "nvidia/*Parakeet*", "nvidia/*Lyra*", "nvidia/*GR00T*", "nvidia/*Sana*", "nvidia/*NVFP4*"], excludePatterns: commonExcludes },
